...
$sql = "SELECT `a`.*, `b`.`fullname` FROM `task_info` `a` LEFT JOIN `tbl_admin` `b` ON(`a`.`t_user_id` = `b`.`user_id`) WHERE `task_id`='$task_id'";
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<a title="Update Task" href="task-info.php"><span class="btn btn-success-custom  btn-xs">
												<< Go Back</span></a>
									</div>
